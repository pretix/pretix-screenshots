...
def shot_event_creation(live_server, organizer, event, logged_in_client):
    ...
    logged_in_client.find_element_by_css_selector("input[name='basics-date_from']").send_keys("2018-02-01 08:00:00")
    logged_in_client.find_element_by_css_selector("input[name='basics-date_to']").send_keys("2018-02-01 18:00:00")
    logged_in_client.find_element_by_css_selector("input[name='basics-name_0']").click()
